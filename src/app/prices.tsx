...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    features: [
      "Everything in Core",
      "Daily in-depth feedback",
      "Half-yearly remote INSCYD metabolic test included",
      "Monthly 1:1 video call (30–45 min) to review progress and adjust plan",
      "Race-week priority line",
      "Daily communication via WhatsApp in addition to TrainingPeaks comments",
      "1-time mid week adjustment plan",
  ...
  },
  {
    ...
    tagline: "You want to have a pro approach to your training.",
    features: [
